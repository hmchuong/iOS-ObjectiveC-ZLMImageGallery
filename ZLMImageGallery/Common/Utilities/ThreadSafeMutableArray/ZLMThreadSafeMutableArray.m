...
@interface ZLMThreadSafeMutableArray()
...
@implementation ZLMThreadSafeMutableArray

- (instancetype)init {
    self = [super init];
    
    _internalArray = [[NSMutableArray alloc]init];
    _tsQueue = dispatch_queue_create("com.vn.vng.zalo.ZLMThreadSafeMutableArray", NULL);
